...
- **Initialize a Vault:** Create and configure a vault PDA to store tokens.
- **Deposit Tokens:** Transfer SPL tokens from the user wallet to the vault.
- **Withdraw Tokens:** Safely release tokens back to the user.
